...
def _cells() -> list[dict]:
    return [
        ...
        md(
            ...
            "",
            f"- The argument, one node at a time: `docs/gsn_view.html`",
            f"- One problem at two lifecycle points: `docs/seam.html`",
            f"- Where every claim comes from: `TRACEABILITY.md`",
            "",
